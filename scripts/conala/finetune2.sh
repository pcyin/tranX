...
freq=${3:-3}
vocab="data/conala/vocab.src_freq${freq}.code_freq${freq}.mined_${mined_num}.api.bin"
...
model_name=finetune.mined.api.dr${dropout}.lr${lr}.lr_de${lr_decay}.lr_da${lr_decay_after_epoch}.beam${beam_size}.seed${seed}.mined_${mined_num}
